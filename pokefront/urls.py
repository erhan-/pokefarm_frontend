...
from frontend.views import PokeList, Sync, Filldata, Position, ReleasePoke, EvolvePoke, Overview, SendConfig, Nickname
...
urlpatterns = [
    ...
    url(r'nickname/(?:(?P<account_id>\d+)/)?$', Nickname.as_view(), name='nickname'),
